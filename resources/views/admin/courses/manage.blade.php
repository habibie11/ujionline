            ...
            <div class="w-full flex flex-col gap-[30px]">
                ...
                <ul class="flex flex-col gap-3">
                    ...
                    <li>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="p-[10px_16px] flex items-center gap-[14px] rounded-full h-11 transition-all duration-300 hover:bg-[#2B82FE]">
                                <div>
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div id="course-test" class="mx-[70px] w-[870px] mt-[30px]">
                ...
                <div class="flex flex-col gap-[30px] mt-2">
                    ...
                    @forelse($questions as $questions)
                        <div class="question-card w-full flex items-center justify-between p-4 border border-[#EEEEEE] rounded-[20px]">
                            <div class="flex flex-col gap-[6px]">
                                ...
                                <p class="font-bold text-xl">{{ $questions->question }}</p>
                            </div>
                            <div class="flex items-center gap-[14px]">
                                <a href="{{ route('dashboard.course_questions.edit', $questions) }}" class="bg-[#0A090B] p-[14px_30px] rounded-full text-white font-semibold">Edit</a>
                                <form method="POST" action="{{ route('dashboard.course_questions.destroy', $questions) }}">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                        <p>
                            Kelas belum memiliki sebuah test.
                        </p>
                    @endforelse
