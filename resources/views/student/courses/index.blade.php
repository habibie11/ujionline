        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="course-list-container flex flex-col px-5 mt-[30px] gap-[30px]">
                ...
                <div class="list-items flex flex-nowrap justify-between pr-10">
                    ...
                    @elseif($course->category->name == "UX Designer")
                          <div class="flex shrink-0 w-[170px] items-center justify-center">
                              <p
                                class="p-[8px_16px] rounded-full bg-[#D5EFFE] font-bold text-sm text-[#066D]"
                              >
                              {{ $course->category->name }}
                              </p>
                            </div>
                    ...
                    <div class="flex shrink-0 w-[120px] items-center">
                        ...
                        <a href=
                        " 
                        {{ route ("dashboard.learning.course", ["course" => $course->id, "question" => $course->nextQuestionId ?? 1])}}
                        "
                        class="w-full h-[41px] p-[10px_20px] bg-[#6436F1] rounded-full font-bold text-sm text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center">Start Test</a>
                        @else
                        <a href="{{ route('dashboard.learning.rapport.course', $course) }}" class="w-full h-[41px] p-[10px_20px]  bg-[#0A090B] rounded-full font-bold text-sm text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center">Results</a>
